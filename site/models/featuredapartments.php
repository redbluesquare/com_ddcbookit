...
class DdcbookitModelsFeaturedapartments extends DdcbookitModelsDefault
{

  /**
  * Protected fields
  **/
  var $_featuredap_id    	= null;
  ...
  */
  protected function _buildQuery()
  {
    ...
    $query->leftJoin('#__ddcbookit_proptypes as proptype on apartment.proptype_title = proptype.ddcbookit_proptype_id And f.proptype_id = proptype.ddcbookit_proptype_id');
